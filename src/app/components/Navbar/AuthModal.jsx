    ...
    return (
        <>
            <div className="fixed top-0  h-screen flex justify-center w-screen  items-center z-50 ">
                ...
                <div className='flex flex-col items-center justify-center md:mx-10 pt-16 pb-12 px-2 md:px-6 w-full max-w-[768px] h-[90vh] overflow-y-auto  rounded-2xl bg-white relative'>
